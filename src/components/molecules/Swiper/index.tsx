  ...
  return (
    <div className={"relative"}>
      ...
      {showNext && (
        <button
          className={
            "rounded-full bg-[#3FA9F5] h-7 w-7  md:h-10 z-[600] flex items-center justify-center md:w-10 absolute right-4 -bottom-20 md:top-1/2 -translate-y-1/2 cursor-pointer"
          }
          onClick={onNext}
        >
          <svg
      ...
      {showPrev && (
        <button
          className={
            "rounded-full z-[1000] bg-[#3FA9F5] h-7 w-7 md:h-10 flex items-center justify-center md:w-10 absolute right-16 -bottom-20  md:right-0 md:left-4 md:top-1/2 -translate-y-1/2 cursor-pointer "
          }
          onClick={onPrev}
        >
          <svg
