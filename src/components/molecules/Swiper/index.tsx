...
export default function SwiperComponent({
  ...
  return (
    <div className={"relative"}>
      <div
        className={
          "flex justify-start pl-2 lg:pl-0 overflow-hidden relative overflow-x-auto " +
          className
        }
        ref={swiperRef}
      >
      ...
      {showNext && (
        <button
          className={
            "rounded-full bg-[#3FA9F5] h-7 w-7  md:h-10 z-[600] flex items-center justify-center md:w-10 absolute right-4 -bottom-10 md:top-1/2 -translate-y-1/2 cursor-pointer"
          }
          onClick={onNext}
        >
          <svg
      ...
      {showPrev && (
        <button
          className={
            "rounded-full z-[1000] bg-[#3FA9F5] h-7 w-7 md:h-10 flex items-center justify-center md:w-10 absolute right-16 -bottom-10  md:right-0 md:left-4 md:top-1/2 -translate-y-1/2 cursor-pointer "
          }
          onClick={onPrev}
        >
          <svg
