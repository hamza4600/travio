...
const LoginPage: FC<LoginPageProps> = ({ email, language }) => {
                ...
                <div className="rounded-2xl overflow-hidden border border-darkblue/10">
                    <div className="grid grid-cols-2 h-12 text-darkblue text-base font-bold divide-x-[1px]">
                        <Link href={`/${language}/login`}>
                            <div
                                className={`flex items-center justify-center h-full ${isLogin ? 'border-b-2 border-yellow-500 bg-white' : 'border-b border-darkblue/10 bg-darkblue/[0.02]'
                                    }`}
                            >
                                Login
                            </div>
