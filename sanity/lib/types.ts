import { content_layouts } from "../schemas/atoms/content";
import { SupportedLanguage } from "../schemas/atoms/locale";
...
export type SanityBlogSidebar = {
  ...
  | SanitySidebarForm
  | SanitySidebarLatestArticles
  | SanitySidebarRelatedTours
)[];
